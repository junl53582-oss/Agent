...
from research_v22.freeze import PARENT_LEDGER, PARENT_SCORES
from research_v22.replay import MEMBERSHIP_PATH, MODES, attach_volatility, compare_control, load_scores, run_replay
from .config import V22R1Settings
from .freeze import DIRECTORY, verify
from .schedule import schedule_from_parent
...
def run():
    ...
    try:
        ...
        report = {"status": "retrospective_global_score_ablation_complete", "lock_sha256": lock["lock_sha256"],
                  ...
                  "limitations": ["Implementation-only repair of V22; the only behavior change is valid access to the parent mode column.",
                                  "Evidence-selected retrospective single-variable ablation; not an untouched confirmation.",
