...
- **当前推进V21分项诊断**：复现不变的模型，检查基线、公告文本、科技子集和目标口径，逐年保存逐股分数并逐期复核父版IC。不是已经改善的新生产模型；不调权重或反转信号。V20/V20r1失败记录及V20r2完整结果均保留。
- 默认网页和顶部全局指标仍为V6；新增研究状态提示。旧V16候选日期与择时日期不一致，不能当成当日完整建议。
- 本轮针对性测试51项通过（V21 9项、结果验收5项、V20r2 21项、状态10项、日志6项）。原研究回归151项中150通过，V18原冻结夹具错误仍保留；本轮未重跑全项目测试或网页AppTest。
