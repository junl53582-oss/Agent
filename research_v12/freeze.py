...
PROTOCOL = "artifacts/research_v12/protocol.json"
LOCK = "artifacts/research_v12/plan.lock.json"
LOCK_HASH = "artifacts/research_v12/plan.lock.sha256"
DATA_FILES = [
...
CODE_FILES = [
    "research_v12/config.py", "research_v12/features.py", "research_v12/model.py",
    "research_v12/risk.py", "research_v12/portfolio.py", "research_v12/backtest.py",
    "research_v12/validation.py", "research_v12/freeze.py", "research_v12/cli.py",
    "tests/test_research_v12.py", "artifacts/research_v12/amendment_001.json",
]
DEPENDENCY_FILES = [
    "research_v10/features.py", "research_v10/model.py", "research_v10/portfolio.py",
    "research_v10/backtest.py", "research_v10/research_config.py", "research_v10/fundamentals.py",
    "research_v10/quality.py", "research_v9/data.py", "research_v9/features.py",
    "research_v6/model.py", "research_v5/models.py", "research_v4/stability.py",
    "stockpilot/data.py", "stockpilot/membership.py", "stockpilot/portfolio.py", "stockpilot/trading.py",
]
...
def freeze_research(root: str | Path = ".") -> dict:
    ...
    if not core.get("passed"):
        raise RuntimeError("核心复制审计未通过，禁止冻结V12")
    import lightgbm
    lock = {
        "protocol": "stockpilot-v12-portfolio-aware-purged-risk-budget",
        ...
        "v12_model_performance_seen_before_lock": False,
    }
...
def verify_research(root: str | Path = ".") -> dict:
    ...
    if actual != expected:
        raise RuntimeError(f"V12冻结锁不匹配: expected={expected}, actual={actual}")
    ...
    if mismatches:
        raise RuntimeError("V12冻结数据或代码已变化:\n" + "\n".join(mismatches))
