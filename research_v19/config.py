...
class V19Settings:
    ...
    artifact_dir: Path = Path("artifacts/research_v19")

    # V19 新增：市场状态自适应权重（预注册）
    weight_bull: float = 0.50    # 上涨市：偏文本/事件驱动
    weight_neutral: float = 0.65 # 震荡市：等同 V16
    weight_bear: float = 0.80    # 下跌市：偏基线/防御
